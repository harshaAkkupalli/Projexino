...
PROJEXINO_BRAND = {
    "logo_url": "https://customer-assets.emergentagent.com/job_projexino-hub/artifacts/k85zxnvo_cropped-projexino-scaled-1-768x358%20%281%29.png",
    "primary": "#F97316",
    "navy": "#0F2042",
    "accent": "#A855F7",
    "company": "Projexino Solutions Pvt Ltd",
    "tagline": "Engineering the Future of Operations",
    "website": "https://projexino.com",
}
...
<body style="margin:0;padding:0;background:#FFF7ED;font-family:Inter,Helvetica,Arial,sans-serif;color:#0F172A">
  <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background:#FFF7ED">
    <tr><td align="center" style="padding:32px 16px">
      <table role="presentation" width="600" cellspacing="0" cellpadding="0" style="max-width:600px;background:#FFFFFF;border-radius:18px;overflow:hidden;box-shadow:0 8px 32px rgba(15,32,66,0.08)">
        <tr><td style="background:linear-gradient(135deg,{PROJEXINO_BRAND['navy']} 0%,#1E293B 60%,{PROJEXINO_BRAND['accent']} 100%);padding:24px 32px">
          <img src="{PROJEXINO_BRAND['logo_url']}" alt="Projexino" height="38" style="display:block">
        </td></tr>
...
def _seed_body_for(slug: str) -> str:
    if slug == "welcome_employee":
        ...
        return _branded_template("Welcome to Projexino", body, "Open Portal", "https://projexino.com/login")
    if slug == "welcome_intern":
        ...
        return _branded_template("Welcome to the Projexino Internship Programme", body, "Open Intern Portal", "https://projexino.com/login")
    if slug == "task_assigned":
        ...
        return _branded_template("New task assigned", body, "View Task", "https://projexino.com/login")
    if slug == "project_assigned":
        ...
        return _branded_template("You've been added to a project", body, "Open Project", "https://projexino.com/login")
    if slug == "badge_awarded":
        ...
        return _branded_template("🏆 New badge earned!", body, "See Your Badges", "https://projexino.com/login")
    if slug == "issue_assigned":
        ...
        return _branded_template("Action needed", body, "Open Issue", "https://projexino.com/login")
    if slug == "document_verified":
        body = '<p>Hi <b>{{name}}</b>,</p><p>Your <b>{{doc_type}}</b> has been reviewed and verified. ✓</p>'
        return _branded_template("Document verified", body, "View Documents", "https://projexino.com/login")
    if slug == "document_rejected":
        ...
        return _branded_template("Please re-upload your document", body, "Re-upload Document", "https://projexino.com/login")
...
def register_email(api: APIRouter, db, get_current_user):
    ...
    async def ai_generate_template(payload: AiTemplateIn, user=Depends(get_current_user)):
        ...
        try:
            ...
            wrapped = _branded_template(subject, inner_body, "Open Portal", "https://projexino.com/login")
        except Exception as e:
    ...
    # ---- Send ----
    async def _do_send(*, to: list, subject: str, body_html: str, from_name: str, reply_to: str, user=None, from_token_id: str = None, cc: list = None, bcc: list = None):
        cc = cc or []
        bcc = bcc or []
