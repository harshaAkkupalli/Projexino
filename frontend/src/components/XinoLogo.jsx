    ...
    >
      ...
      {glow && (
        <motion.div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(249,115,22,0.55) 0%, rgba(168,85,247,0.35) 45%, transparent 70%)",
            filter: "blur(8px)",
          }}
      ...
      <svg
        ...
        width={s}
        height={s}
        className="relative drop-shadow-[0_8px_24px_rgba(249,115,22,0.45)]"
      >
        <defs>
        ...
        >
          ...
          <circle cx="50" cy="50" r="2.6" fill="#F97316" />
        </motion.g>
