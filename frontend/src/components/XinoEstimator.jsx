    ...
    <>
      ...
      {showFloating && !open && createPortal(
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          className="fixed bottom-6 right-6 z-[70] flex items-center gap-3 rounded-full bg-gradient-to-br from-[#0F2042] via-[#7C3AED] to-[#F97316] py-3 pl-3 pr-5 text-sm font-bold text-white shadow-[0_18px_40px_-12px_rgba(249,115,22,0.55)] ring-1 ring-white/20 backdrop-blur-md hover:shadow-[0_24px_50px_-12px_rgba(168,85,247,0.65)]"
        >
